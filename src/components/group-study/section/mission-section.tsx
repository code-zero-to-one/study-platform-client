...
import { useGetMissions } from '@/hooks/queries/group-study/mission-queries';
import { useGroupStudyDetailQuery } from '@/hooks/queries/one-to-one/use-study-query';

const HomeworkDetailContent = dynamic(
  () => import('@/components/home/homework-detail-content'),
  { ssr: false },
);

const MissionDetailContent = dynamic(
  () => import('@/components/home/mission-detail-content'),
  { ssr: false },
);
