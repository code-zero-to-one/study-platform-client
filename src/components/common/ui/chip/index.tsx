...
const chipVariants = cva(
  ' itmes-center flex min-h-[40px] justify-center rounded-full border border-border-subtle p-[8px] text-[14px] leading-[22px] font-[500] text-[var(--color-text-default)]',
  {
    variants: {
      color: {
        default:
