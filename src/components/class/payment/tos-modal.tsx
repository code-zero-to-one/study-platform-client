  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative z-10 flex max-h-[730px] w-full max-w-[840px] flex-col overflow-hidden rounded-200 bg-background-default">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-gray-300 px-500 py-400">
          ...
          >
            <X className="size-350 text-gray-800" />
          </button>
        </div>
