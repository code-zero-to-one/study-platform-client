          ...
          >
            ...
            >
              <div className="flex items-center">
                <span className="mr-125 font-designer-16m text-text-brand">
                  Q
                </span>
              ...
              {expandedFaq === idx ? (
                <ChevronUp className="size-300 shrink-0 text-gray-800" />
              ) : (
                <ChevronDown className="size-300 shrink-0 text-gray-800" />
              )}
            </button>
            {expandedFaq === idx && (
