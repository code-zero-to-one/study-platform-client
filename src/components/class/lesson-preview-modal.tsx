...
export function LessonPreviewModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="sm:max-w-10500 gap-0 overflow-hidden rounded-200 border-0 bg-background-default p-0">
        {/* Header */}
        <div className="flex flex-wrap items-center gap-125 px-400 pt-500 sm:px-875 sm:pt-750">
          ...
          <span className="font-designer-18b text-gray-600">
            {chapter.title}
          </span>
        ...
        {/* Divider */}
        <div className="mx-400 mt-375 border-t border-gray-200 sm:mx-875" />
        {/* Body: lesson type + title + together pill */}
        <div className="flex w-full flex-col gap-300 px-400 pt-375 sm:px-875 md:flex-row md:items-start md:justify-between">
        ...
        {/* 학습 목표 */}
        <div className="flex flex-col gap-75 px-400 pt-375 sm:px-875">
        ...
        {/* CTAs */}
        <div className="flex flex-col gap-150 px-400 pb-500 pt-375 sm:px-875 sm:pb-875">
          <button
            type="button"
            onClick={onStart}
