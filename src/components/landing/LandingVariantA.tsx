  ...
  return (
    <>
      <div>
        ...
        <section className="relative flex flex-col items-center gap-600 py-[80px]">
          ...
          <div className="relative h-[591px] w-[1000px]">
            <Image
              ...
              height={590}
            />
            {/* TODO: [A안] 실제 히어로 이미지 경로 교체 필요 */}
            <div className="pointer-events-none absolute bottom-0 left-0 h-[120px] w-full bg-gradient-to-t from-[#ffffff] to-transparent" />
          </div>
        </section>

        {/* ====================================== */}
        {/* Stats Section (A안의 핵심: 먼저 보여줌) */}
        {/* ====================================== */}
        <section className="flex flex-col items-center gap-500 bg-gradient-to-b from-white via-[#fff8f9] to-white py-[120px]">
            ...
            {STATS_SECTION.stats.map((stat, index) => (
              ...
              >
                ...
                <div className="relative h-[120px] w-[120px]">
                  <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-pink-100 to-purple-100">
                    {/* TODO: [A안] 실제 아이콘 이미지 경로 교체 필요 */}
        ...
        {/* ====================================== */}
        {/* Reviews Section (A안에서는 나중에) */}
        {/* ====================================== */}
        <section className="mx-auto flex w-[1160px] max-w-7xl flex-col items-center gap-600 py-[120px]">
          <h2 className="font-bold-h2 text-text-strong text-center">
            {REVIEWS_SECTION.title}
          </h2>

          <div className="grid w-full grid-cols-2 gap-x-[120px] gap-y-400">
              ...
              >
                {review.position === 'left' && (
                  <div className="relative h-[64px] w-[64px] flex-shrink-0">
                    {/* TODO: [A안] 실제 아바타 이미지 경로 교체 필요 */}
                    <div className="h-full w-full rounded-full bg-gradient-to-br from-blue-200 to-purple-200" />
                  </div>
                )}

                <div
                  className={`rounded-300 bg-background-subtle max-w-[400px] px-400 py-300 ${
                ...
                {review.position === 'right' && (
                  <div className="relative h-[64px] w-[64px] flex-shrink-0">
                    {/* TODO: [A안] 실제 아바타 이미지 경로 교체 필요 */}
                    <div className="h-full w-full rounded-full bg-gradient-to-br from-pink-200 to-orange-200" />
                  </div>
                )}
              </div>
            ))}
        ...
        <section className="bg-background-subtle flex flex-col items-center gap-500 py-[120px]">
          ...
          <ul className="mt-400 grid grid-cols-3 gap-300">
            {GROWTH_SECTION.cards.map((card, index) => (
              ...
              >
                ...
                <div className="relative h-[200px] w-full">
                  {/* TODO: [A안] 실제 카드 이미지 경로 교체 필요 */}
                  <div className="rounded-200 h-full w-full bg-gradient-to-br from-slate-100 to-slate-200" />
                </div>
              </li>
            ))}
          </ul>
        ...
        <section className="mx-auto flex w-[1160px] max-w-7xl items-center justify-between gap-400 py-[120px]">
          ...
          <div className="relative h-[400px] w-[600px]">
            {/* TODO: [A안] 실제 멘토링 이미지 경로 교체 필요 */}
            <div className="rounded-200 h-full w-full bg-gradient-to-br from-gray-100 to-gray-200" />
          </div>
        </section>
        ...
        <section className="bg-background-subtle flex flex-col items-center gap-500 py-[120px]">
          ...
          <p className="flex flex-col items-center gap-100">
            ...
            <span className="text-text-subtle font-designer-16m max-w-[800px] text-center">
          ...
          <ul className="mt-400 grid grid-cols-4 gap-300">
            {MENTOR_SECTION.mentors.map((mentor) => (
              ...
              >
                <div className="relative h-[120px] w-[120px]">
                  {/* TODO: [A안] 실제 멘토 아바타 이미지 경로 교체 필요 */}
                  <div className="h-full w-full rounded-full bg-gradient-to-br from-indigo-200 to-pink-200" />
                </div>
