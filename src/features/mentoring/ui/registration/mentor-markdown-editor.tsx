...
const toFileFromDataUrl = (dataUrl: string, fileName: string): File | undefined => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      handlePaste: (view, event) => {
        ...
        const imageFiles = extractImageFiles(clipboardData ?? undefined);
      ...
      handleDrop: (view, event) => {
        ...
        const imageFiles = extractImageFiles(dataTransfer ?? undefined);
