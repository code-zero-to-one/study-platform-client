...
const DEMO_SECTIONS = Array.from({ length: SCROLL_TEST_SECTION_COUNT }, (_, i) => {
  ...
  return (
    <section className="rounded-200 border-border-subtle bg-background-default mb-250 border p-250">
      ...
      <div className="relative">
        ...
        <aside
          className="pointer-events-none fixed z-40 [top:50%]"
          style={{ left: `calc(50% + ${CARD_HORIZONTAL_SHIFT}px)` }}
        >
          <article
            className="pointer-events-auto w-[320px] rounded-150 border-border-brand bg-background-default shadow-2 border p-200 will-change-transform"
            style={{
          ...
          >
            ...
            <div className="space-y-75">
              ...
              <p className="font-designer-14b text-text-default flex items-center gap-50">
                {scrollDirection === 'down' && <ArrowDown className="h-14 w-14" />}
