                  ...
                  <div className="mb-150 flex flex-wrap gap-75">
                    ...
                    {REJECT_PRESETS.map((preset) => (
                      <button
                        ...
                        className={`rounded-100 border px-125 py-75 transition-colors font-designer-13m ${rejectReason === preset ? 'border-border-brand bg-fill-brand-subtle-default text-text-brand' : 'border-border-default text-text-subtle hover:border-border-brand hover:text-text-brand'}`}
                      >
                        {' '}
                        {preset}{' '}
                      </button>
