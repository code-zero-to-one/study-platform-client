    ...
    <section>
      ...
      <div className="mb-75 flex items-center justify-between">
        ...
        <div className="flex items-center gap-75">
          ...
          <span className="ml-50 font-designer-14b text-text-strong">
            {' '}
            {mentor.rating.toFixed(1)}{' '}
          </span>{' '}
        </div>{' '}
      </div>{' '}
      <p className="mb-250 font-designer-13r text-text-subtlest">
        {' '}
          ...
          {mentor.reviews.map((review, idx) => (
            ...
            >
              ...
              <div className="mb-150 flex items-start justify-between gap-100">
                ...
                <p className="shrink-0 font-designer-12r text-text-subtlest">
                  {' '}
                  {review.createdAt}{' '}
                </p>{' '}
              </div>{' '}
              <p className="leading-relaxed font-designer-14r text-text-subtle">
                {' '}
                {review.content}{' '}
              </p>{' '}
            </article>
