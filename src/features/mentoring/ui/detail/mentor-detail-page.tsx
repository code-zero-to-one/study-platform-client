      ...
      >
        ...
        <aside className={cn('h-fit', !previewMode && 'xl:self-start')}>
          <div
            ...
            className={cn(
              !previewMode &&
                'xl:fixed xl:top-panel-offset xl:right-panel-offset xl:z-10 xl:h-panel-height xl:w-360px xl:overflow-hidden xl:transition-none xl:will-change-transform xl:translate-y-panel',
            )}
            style={
              previewMode
                ? undefined
