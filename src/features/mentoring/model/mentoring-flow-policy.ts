...
export const MENTORING_NOTIFICATION_GUIDE =
  '중요 안내는 사이트 알림함과 등록된 연락처를 기준으로 전달됩니다.';
...
export const MENTORING_CHANGE_AND_NO_SHOW_GUIDE =
  '일정 변경, 직전 취소, 노쇼 처리 결과는 알림과 나의 멘토링에 기록으로 남습니다.';
...
> = {
  note: {
    steps: [
      ...
      '이후 후속 질문도 같은 화면에서 이어갈 수 있습니다.',
    ],
    mentorAction:
      '수락 후 첫 답변까지 남겨야 멘티가 후속 질문을 이어갈 수 있습니다.',
    issueGuide:
      '거절, 미응답, 추가 질문 기록은 쪽지상담 화면에 그대로 남습니다.',
    channelGuide:
      '쪽지상담은 서비스 내 쪽지 화면에서 진행됩니다. 멘토 첫 답변 이후 후속 질문도 같은 화면에서 이어갈 수 있어요.',
    progressGuide:
      '답변 상태와 후속 질문은 쪽지상담 화면에서 이어서 확인할 수 있어요.',
    completionSummary:
      '결제가 끝났어요. 멘토가 첫 답변을 보내면 상담이 시작됩니다.',
    completionSteps: [
      '멘토가 신청을 수락하고 첫 답변을 남기면 알림이 도착합니다.',
      '추가 자료와 후속 질문은 쪽지상담 화면에서 이어서 보내세요.',
    ],
  },
  simple: {
    steps: [
      ...
      '확정된 일정과 변경 내역은 알림과 나의 멘토링에서 확인합니다.',
    ],
    mentorAction: '수락할 때 확정 시간과 진행 채널을 함께 남겨주세요.',
    issueGuide: '직전 취소, 변경, 노쇼 결과는 알림과 나의 멘토링에 기록됩니다.',
    channelGuide:
      '기본 진행 채널은 디스코드입니다. 필요한 경우 멘토와 다른 방식도 사전에 협의할 수 있어요.',
    progressGuide:
      '확정된 시간과 통화 안내는 알림과 나의 멘토링에서 이어서 확인할 수 있어요.',
    completionSummary:
      '결제가 끝났어요. 멘토가 짧은 상담 시간과 진행 채널을 확인합니다.',
    completionSteps: [
      '멘토 확인 후 확정 시간과 진행 채널이 알림으로 안내됩니다.',
  ...
  deep: {
    ...
    issueGuide:
      '취소, 일정 재조율, 노쇼 처리는 알림과 히스토리에 함께 남습니다.',
    channelGuide:
      '기본 진행 채널은 디스코드입니다. 필요한 경우 멘토와 다른 방식도 사전에 협의할 수 있어요.',
    progressGuide:
      '확정된 시간과 진행 링크는 알림과 나의 멘토링에서 이어서 확인할 수 있어요.',
    completionSummary:
      '결제가 끝났어요. 멘토가 화상 기준 일정과 진행 링크를 확인합니다.',
    completionSteps: [
      '멘토 확인 후 확정 시간과 진행 링크가 알림으로 안내됩니다.',
  ...
  offline: {
    ...
    progressGuide:
      '확정된 시간과 장소 안내는 알림과 나의 멘토링에서 이어서 확인할 수 있어요.',
    completionSummary: '결제가 끝났어요. 멘토가 일정과 장소 안내를 확인합니다.',
    completionSteps: [
      '멘토 확인 후 확정 시간과 장소 안내가 알림으로 전달됩니다.',
...
export const getMyMentoringStatusGuide = (status: MyMentoringStatus) => {
  ...
  if (status === 'CANCELLED') {
    return '취소 사유와 후속 안내를 먼저 확인해주세요. 결제나 재예약 관련 안내는 알림으로 함께 전달됩니다.';
  }
...
export const getMentoringMentorRequestChecklist = ({
  ...
  checklist.push(
    '수락, 거절, 변경, 취소는 모두 대화 기록과 알림에 남으므로 멘티가 다음 행동을 알 수 있게 작성하세요.',
  );
      ...
      items:
        viewer === 'mentor'
          ? [
              ...
              '환불 대기나 일정 변경이 생기면 알림과 대화 기록에 후속 안내를 남겨두세요.',
            ]
          : [
              '상담 전 변경이나 취소가 생기면 알림과 이 화면에 함께 기록됩니다.',
              '멘토 취소나 노쇼가 발생하면 환불 또는 재예약 안내가 같이 남습니다.',
              '긴급한 상담은 알림 확인 후 새 신청으로 다시 잡는 편이 가장 빠릅니다.',
            ],
    };
  }
      ...
      items:
        viewer === 'mentor'
          ? [
              ...
              '환불 상태가 PENDING이면 전액 또는 부분 환불 진행 여부를 알림에 같이 남기세요.',
              '대체 일정이 어렵다면 새 신청 경로를 명확히 안내하는 편이 안전합니다.',
            ]
          : [
              '취소 사유와 환불 상태를 먼저 확인하세요.',
              '환불 진행 중이면 알림함에서 후속 안내를 함께 확인하세요.',
      ...
      items:
        viewer === 'mentor'
          ...
          : [
              ...
              '환불 상태가 PENDING이면 알림함에서 후속 안내를 같이 확인하세요.',
      ...
      items:
        viewer === 'mentor'
          ...
          : [
              ...
              '환불 상태가 PENDING이면 알림함과 대화 기록을 함께 확인하세요.',
      ...
      viewer === 'mentor'
        ...
        : [
            ...
            refundStatus === 'NOT_ELIGIBLE'
              ? '이번 건은 환불 대상이 아닐 수 있으니 운영 기록과 알림을 같이 확인하세요.'
              : '환불 상태가 남아 있다면 알림함에서 후속 안내를 확인하세요.',
          ],
  };
};
