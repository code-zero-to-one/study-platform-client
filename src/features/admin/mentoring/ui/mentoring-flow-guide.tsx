 ...
 *
 * MentorScreeningStatus  → src/types/mentoring/admin-domain.ts
 * MentorOperationStatus  → src/types/mentoring/admin-domain.ts
 * MentoringRequestStatus → src/types/mentoring/management-domain.ts
 * MentoringPaymentStatus → src/types/mentoring/management-domain.ts
 * MentoringPaymentMode   → src/types/mentoring/management-domain.ts
 * MentoringSessionStatus → src/types/mentoring/management-domain.ts
