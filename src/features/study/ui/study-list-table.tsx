...
function mapDailyStudyToDisplayData(
  ...
  const interviewee = {
    ...
    img: `https://picsum.photos/id/${getImageIdFromName(row.interviewee)}/40/40`,
  };
  const interviewer = {
    name: row.interviewer,
    img: `https://picsum.photos/id/${getImageIdFromName(row.interviewer)}/40/40`,
  };
...
export default function StudyListSection() {
  ...
  const displayData: Record<Header, React.ReactNode>[] = mockData.map(
