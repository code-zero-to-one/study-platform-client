...
export const AligoKakaoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTemplates1: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AligoKakaoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTemplates1(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTemplates1(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AligoKakaoApi.getTemplates1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 서버에 캐시된 템플릿과 Kakao API의 최신 템플릿 상태를 비교하여 동기화 상태를 확인합니다. - 동기화됨: 캐시와 API의 템플릿이 완전히 일치 - 캐시 미초기화: 서버 시작 후 템플릿이 캐시되지 않음 - API 조회 실패: Kakao API 연결 실패 - 부분 동기화: 템플릿 개수 또는 내용 불일치 
...
export const AligoKakaoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTemplates1(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getTemplates1(options).then((request) => request(axios, basePath));
        },
        /**
         * 서버에 캐시된 템플릿과 Kakao API의 최신 템플릿 상태를 비교하여 동기화 상태를 확인합니다. - 동기화됨: 캐시와 API의 템플릿이 완전히 일치 - 캐시 미초기화: 서버 시작 후 템플릿이 캐시되지 않음 - API 조회 실패: Kakao API 연결 실패 - 부분 동기화: 템플릿 개수 또는 내용 불일치 
         * @summary 템플릿 동기화 상태 확인
...
export class AligoKakaoApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getTemplates1(options?: RawAxiosRequestConfig) {
        return AligoKakaoApiFp(this.configuration).getTemplates1(options).then((request) => request(this.axios, this.basePath));
    }
