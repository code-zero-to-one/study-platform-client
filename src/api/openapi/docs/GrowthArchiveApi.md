...
|[**recordView1**](#recordview1) | **POST** /api/v1/archive/{id}/view | |
|[**toggleBookmark**](#togglebookmark) | **POST** /api/v1/archive/{id}/bookmark | 아카이브 북마크 토글|
|[**toggleLike1**](#togglelike1) | **POST** /api/v1/archive/{id}/like | 아카이브 좋아요 토글|
...
const { status, data } = await apiInstance.recordView1(
    id
);
```
...
# **toggleLike1**
> ToggleLikeResponseSchema toggleLike1()
...
const { status, data } = await apiInstance.toggleLike1(
    id
);
```
