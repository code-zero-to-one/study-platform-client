...
**interviewPost** | [**GroupStudyInterviewPostRequest**](GroupStudyInterviewPostRequest.md) | 그룹스터디 개설질문 | [default to undefined]
**thumbnailExtension** | **string** | 썸네일 이미지 확장자 | [optional] [default to undefined]

## Example

```typescript
import { GroupStudyUpdateRequest } from './api';

const instance: GroupStudyUpdateRequest = {
    basicInfo,
    detailInfo,
    interviewPost,
    thumbnailExtension,
