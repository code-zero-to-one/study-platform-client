...
**refundedAt** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { StudyRefundSummaryResponse } from './api';

const instance: StudyRefundSummaryResponse = {
    refundId,
    refundCode,
    paymentId,
    paymentCode,
