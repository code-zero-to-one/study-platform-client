...
**content** | [**Array&lt;BankResponse&gt;**](BankResponse.md) | Content | [optional] [default to undefined]
**message** | **string** | Message | [optional] [default to undefined]

## Example

```typescript
import { BankListResponseSchema } from './api';

const instance: BankListResponseSchema = {
    statusCode,
    timestamp,
    content,
    message,
