...
**dislikesCount** | **number** |  | [optional] [default to undefined]
**myReaction** | **string** |  | [optional] [default to undefined]
...
```typescript
import { ThreadCommentResponseContent } from './api';

const instance: ThreadCommentResponseContent = {
    commentId,
    threadId,
    authorId,
    authorName,
