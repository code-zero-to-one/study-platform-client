...
**content** | [**CourseDrawerResponse**](CourseDrawerResponse.md) | Content | [optional] [default to undefined]
**message** | **string** | Message | [optional] [default to undefined]

## Example

```typescript
import { CourseDrawerResponse } from './api';

const instance: CourseDrawerResponse = {
    statusCode,
    timestamp,
    content,
    message,
