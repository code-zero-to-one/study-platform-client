...
|[**deleteQuestion**](#deletequestion) | **DELETE** /api/v1/group-studies/{groupStudyId}/questions/{questionId} | 그룹스터디 질문 삭제|
...
|[**modifyQuestion**](#modifyquestion) | **PATCH** /api/v1/group-studies/{groupStudyId}/questions/{questionId} | |
...
질문 ID를 통해 특정 질문을 삭제합니다. (Soft Delete)  **[권한]** - 작성자, 그룹스터디 리더, 관리자만 삭제 가능  **[Request]** - PathVariable: groupStudyId (필수) - 그룹스터디 ID - PathVariable: questionId (필수) - 질문 ID 
...
|-------------|-------------|------------------|
|**204** | 질문 삭제 성공 |  -  |
|**403** | 질문 삭제 권한 없음 (QST004) |  -  |
|**404** | 질문을 찾을 수 없음 (QST003) |  -  |
|**409** | 이미 삭제된 질문 (QST007) |  -  |
...
# **modifyQuestion**
> BaseResponseQuestionUpdateResponse modifyQuestion(questionUpdateRequest)
...
const { status, data } = await apiInstance.modifyQuestion(
    groupStudyId,
    questionId,
    questionUpdateRequest
);
...
**BaseResponseQuestionUpdateResponse**
