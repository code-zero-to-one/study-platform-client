# PageResponseDtoMyGroupStudyApplyListItemDto
...
```typescript
import { PageResponseDtoMyGroupStudyApplyListItemDto } from './api';

const instance: PageResponseDtoMyGroupStudyApplyListItemDto = {
    content,
    page,
    size,
    totalElements,
