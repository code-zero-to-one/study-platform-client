...
**applicantInfo** | [**GroupStudyApplicant**](GroupStudyApplicant.md) | 신청자 정보 - ID, 프로필 이미지, 성실온도 | [optional] [default to undefined]
...
```typescript
import { GroupStudyApplyListItem } from './api';

const instance: GroupStudyApplyListItem = {
    applyId,
    applicantInfo,
    interviewPost,
    answer,
