...
**content** | [**PhoneAuthResponseDto**](PhoneAuthResponseDto.md) | Content | [optional] [default to undefined]
**message** | **string** | Message | [optional] [default to undefined]

## Example

```typescript
import { PhoneAuthResponseSchema } from './api';

const instance: PhoneAuthResponseSchema = {
    statusCode,
    timestamp,
    content,
    message,
