...
**content** | [**AligoListResponseDto**](AligoListResponseDto.md) | Content | [optional] [default to undefined]
**message** | **string** | Message | [optional] [default to undefined]

## Example

```typescript
import { AligoListResponseSchema } from './api';

const instance: AligoListResponseSchema = {
    statusCode,
    timestamp,
    content,
    message,
