...
|[**getParticipatingStudies1**](#getparticipatingstudies1) | **GET** /api/v1/members/{memberId}/studies | 회원의 참여 스터디 조회|
...
# **getParticipatingStudies1**
> ParticipatingStudyResponse getParticipatingStudies1()
...
const { status, data } = await apiInstance.getParticipatingStudies1(
    memberId,
    studyType,
    studyStatus,
    inProgressPage,
