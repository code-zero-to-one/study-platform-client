# BaseResponseToggleArchiveVisibilityResponseDto
...
```typescript
import { BaseResponseToggleArchiveVisibilityResponseDto } from './api';

const instance: BaseResponseToggleArchiveVisibilityResponseDto = {
    statusCode,
    timestamp,
    content,
    message,
