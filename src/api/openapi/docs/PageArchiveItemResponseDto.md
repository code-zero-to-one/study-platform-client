...
**content** | [**Array&lt;ArchiveItemResponseDto&gt;**](ArchiveItemResponseDto.md) |  | [optional] [default to undefined]
...
```typescript
import { PageArchiveItemResponseDto } from './api';

const instance: PageArchiveItemResponseDto = {
    totalElements,
    totalPages,
    first,
    last,
