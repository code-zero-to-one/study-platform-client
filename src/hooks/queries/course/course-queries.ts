...
import type {
  ...
  CourseFeedbackOptionsResponse,
  CourseFeedbackSubmitRequest,
  CourseFeedbackSubmitResponse,
...
export const useCreateCourseFreeEnrollment = (): UseMutationResult<
  CourseFreeEnrollmentResponse,
  Error,
  number
> => {
...
export const useCreateOpenAlertSubscription = (): UseMutationResult<
  OpenAlertSubscriptionResponse,
  Error,
  { courseId: number; request: OpenAlertSubscriptionRequest }
> => {
  return useMutation({
    mutationFn: async ({
      courseId,
...
export const useCreateStudyWithMeSubscription = (): UseMutationResult<
  StudyWithMeSubscriptionResponse,
  Error,
  { courseId: number; request: StudyWithMeSubscriptionRequest }
> => {
  return useMutation({
    mutationFn: async ({
      courseId,
...
export const usePrepareCoursePayment = (): UseMutationResult<
  CoursePaymentPrepareResponse,
  Error,
  { courseId: number; request: CoursePaymentPrepareRequest }
> => {
  return useMutation({
    mutationFn: async ({
      courseId,
...
export const useConfirmCourseTossPayment = (): UseMutationResult<
  CoursePaymentConfirmResponse,
  Error,
  { courseId: number; request: CourseTossPaymentConfirmRequest }
> => {
  return useMutation({
    mutationFn: async ({
      courseId,
...
> => {
  ...
  return useMutation<void, Error, { courseId: number; paymentId: number }>({
...
): UseQueryResult<MyCoursePaymentListItemResponse[]> => {
  return useQuery({
...
export const useRequestCourseRefund = (): UseMutationResult<
  void,
  Error,
  { paymentId: number; request: CourseRefundCreateRequest }
> => {
  const queryClient = useQueryClient();
...
// 백엔드 미배포 — MSW mock 으로 선개발. 배포 시 mock 핸들러만 제거.
// TODO: confirm endpoint (placeholder: /api/v5/courses/{courseId}/feedback).

export const useGetCourseFeedbackOptions = (
  courseId: number,
): UseQueryResult<CourseFeedbackOptionsResponse> => {
  return useQuery({
    queryKey: ['courseFeedbackOptions', courseId],
    queryFn: async () => {
      const { data } = await axiosInstanceV5.get<{
        content: CourseFeedbackOptionsResponse;
...
export const useSubmitCourseFeedback = (): UseMutationResult<
  CourseFeedbackSubmitResponse,
  Error,
  { courseId: number; request: CourseFeedbackSubmitRequest }
> => {
  return useMutation({
    mutationFn: async ({
      courseId,
      ...
      courseId: number;
      request: CourseFeedbackSubmitRequest;
    }) => {
      const { data } = await axiosInstanceV5.post<{
        content: CourseFeedbackSubmitResponse;
...
export const useSubmitNextPlan = (): UseMutationResult<
  unknown,
  Error,
...
export const useGetLessonRetrospective = (
  lessonId: number,
): UseQueryResult<LessonRetrospectiveResponse> => {
  return useQuery({
...
export const useSubmitLessonRetrospective = (): UseMutationResult<
  LessonRetrospectiveCreateResponse,
  Error,
  { lessonId: number; request: LessonRetrospectiveCreateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useGetCourseQnas = ({
  ...
  filter?: string;
  sort?: string;
  // 백엔드 미배포 — MSW mock. TODO: confirm chapterId/lessonId param support with backend.
  chapterId?: number;
  lessonId?: number;
}): UseQueryResult<LessonQnaListResponse> => {
  return useQuery({
    queryKey: [
      'courseQnas',
      courseId,
    ...
    queryFn: async () => {
      const { data } = await axiosInstanceV5.get<{
        ...
        params: { search, filter, sort, chapterId, lessonId },
      });
      return data.content;
    },
    enabled: !!courseId,
...
export const useCreateLessonQna = (): UseMutationResult<
  { qnaId: number },
  Error,
  { courseId: number; request: LessonQnaCreateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useGetLessonQnaDetail = (
  qnaId: number | null,
): UseQueryResult<LessonQnaDetailResponse> => {
  return useQuery({
...
export const useCreateLessonQnaAnswer = (): UseMutationResult<
  { answerId: number },
  Error,
  { qnaId: number; request: LessonQnaAnswerCreateRequest }
> => {
  const queryClient = useQueryClient();
...
export const useReactLessonQna = (): UseMutationResult<
  LessonQnaQuestionReactionToggleResponse & { qnaId: number },
  Error,
  { qnaId: number; request: LessonQnaReactionRequest }
> => {
  const queryClient = useQueryClient();
...
export const useReactLessonQnaAnswer = (): UseMutationResult<
  LessonQnaAnswerReactionToggleResponse & { answerId: number; qnaId: number },
  Error,
  { answerId: number; qnaId: number; request: LessonQnaAnswerReactionRequest }
> => {
  const queryClient = useQueryClient();
...
export const useReportLessonQna = (): UseMutationResult<
  unknown,
  Error,
  { qnaId: number; request: LessonQnaReportRequest }
> => {
  return useMutation({
    mutationFn: async ({
      qnaId,
...
export const useUpdateLessonQna = (): UseMutationResult<
  LessonQnaUpdateResponse,
  Error,
  { qnaId: number; request: LessonQnaUpdateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useDeleteLessonQna = (): UseMutationResult<
  LessonQnaDeleteResponse,
  Error,
  { qnaId: number }
> => {
...
export const useUpdateLessonQnaAnswer = (): UseMutationResult<
  LessonQnaAnswerUpdateResponse,
  Error,
  { answerId: number; qnaId: number; request: LessonQnaAnswerUpdateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useDeleteLessonQnaAnswer = (): UseMutationResult<
  LessonQnaAnswerDeleteResponse,
  Error,
  { answerId: number; qnaId: number }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useGetBuilderFeeds = ({
  ...
  page?: number;
  size?: number;
}): UseQueryResult<BuilderFeedListResponse> => {
  return useQuery({
    queryKey: [
      'builderFeeds',
      courseId,
...
export const useCreateBuilderFeed = (): UseMutationResult<
  { feedId: number },
  Error,
  { courseId: number; request: BuilderFeedCreateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useGetBuilderFeedDetail = (
  feedId: number,
): UseQueryResult<BuilderFeedDetailResponse> => {
  return useQuery({
...
export const useToggleFeedLike = (): UseMutationResult<
...
export const useGetFeedComments = (
  feedId: number,
): UseQueryResult<BuilderFeedCommentsResponse> => {
  return useQuery({
...
export const useCreateFeedComment = (): UseMutationResult<
  { commentId: number },
  Error,
  { feedId: number; request: BuilderFeedCommentCreateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useReportBuilderFeed = (): UseMutationResult<
  { reportId: number },
  Error,
  { feedId: number; request: BuilderFeedReportCreateRequest }
> => {
  return useMutation({
    mutationFn: async ({
      feedId,
...
export const useDeleteBuilderFeed = (): UseMutationResult<
  void,
  Error,
  number
> => {
...
export const useUpdateBuilderFeed = (): UseMutationResult<
  { feedId: number },
  Error,
  { feedId: number; request: BuilderFeedUpdateRequest }
> => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
export const useGetLessonBuilderFeedPreview = (
  lessonId: number,
): UseQueryResult<BuilderFeedPreviewResponse> => {
  return useQuery({
...
export const useGetBuilderFeedShowcase = (
  courseId: number,
): UseQueryResult<BuilderFeedShowcaseResponse> => {
  return useQuery({
...
export const useGetMyBuilderFeedStats =
  (): UseQueryResult<BuilderFeedStatsResponse> => {
    return useQuery({
      queryKey: ['myBuilderFeedStats'],
      queryFn: async () => {
        const { data } = await axiosInstanceV5.get<{
...
export const useGetMyBuilderFeeds =
  (): UseQueryResult<MyBuilderFeedsResponse> => {
    return useQuery({
      queryKey: ['myBuilderFeeds'],
      queryFn: async () => {
        const { data } = await axiosInstanceV5.get<{
...
export const useGetLessonQnaSidebar = (
  lessonId: number,
): UseQueryResult<LessonQnaSidebarResponse> => {
  return useQuery({
...
export const useGetMyGiftEmail = (options?: {
  enabled?: boolean;
}): UseQueryResult<GiftEmailResponse> => {
  return useQuery({
...
export const useRegisterGiftEmail = (): UseMutationResult<
  GiftEmailResponse,
  Error,
  GiftEmailCreateRequest
> => {
