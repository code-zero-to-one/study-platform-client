...
function getUserFriendlyMessage(
  ...
  if (errorCode) {
    const codeMessages: Record<string, string> = {
      // === AUTH (인증) ===
      AUTH001: '인증 상태를 다시 확인하고 있습니다. 잠시 후 다시 시도해주세요.',
      AUTH002: '접근 권한이 없습니다.',
      AUTH003: '인증 정보가 만료되었습니다. 다시 로그인해주세요.',
      AUTH004: '로그인 세션이 만료되었습니다. 다시 로그인해주세요.',
      ...
      // === CRS 레슨 돌아보기(Retrospective) ===
      CRS009: '별점은 1부터 5 사이로 선택해주세요.',
      CRS010: '돌아보기 내용을 입력해주세요.',
      CRS011: '결과물 스크린샷 또는 링크를 등록해주세요.',
      CRS012: '지원하지 않는 결과물 형식입니다.',
      CRS013: '피드백 칩을 6개 중 최소 2개 이상 선택해주세요.',
      CRS014: '이미 돌아보기를 제출한 레슨입니다.',
      CRS015: '제출한 돌아보기를 찾을 수 없습니다.',
      CRS016: '자유 피드백은 500자 이하로 입력해주세요.',
      CRS017: '이 레슨에서는 결과물을 제출할 수 없습니다.',
      CRS049: '피드백 칩 또는 의견을 입력해주세요.',
    };
