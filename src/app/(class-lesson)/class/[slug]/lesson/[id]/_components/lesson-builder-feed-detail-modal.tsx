...
import { useGetBuilderFeedDetail } from '@/hooks/queries/course/course-queries';
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-300">
              ...
              <div className="flex items-center gap-200 border-t border-border-subtle pt-250">
                <div className="flex items-center gap-50">
                  <Heart className="size-250 text-gray-800" />
                  <p className="font-designer-14r text-gray-800">
                    {feed.likeCount}
                  </p>
                </div>
                <div className="flex items-center gap-50">
                  <MessageCircle className="size-250 text-gray-800" />
                  <p className="font-designer-14r text-gray-800">
                    {feed.commentCount}
                  </p>
                </div>
