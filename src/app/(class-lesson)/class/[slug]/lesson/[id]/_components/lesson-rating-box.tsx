...
export function RatingBox({ rating, onChange }: Props) {
  ...
  return (
    <div className="flex h-[120px] w-full flex-col items-center justify-center gap-100 rounded-200 border border-gray-300 bg-background-default mb-375">
