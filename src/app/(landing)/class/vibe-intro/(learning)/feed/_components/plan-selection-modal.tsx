...
export function PlanSelectionModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-7850 overflow-y-auto rounded-200 bg-gray-0 pb-875 pt-875"
          ...
          <div className="px-350 pb-350 pt-350">
            ...
            {plan.subtitle && (
              <div className="mb-200 flex items-center gap-75">
                <Gift className="h-300 w-300 text-rose-500" />
            ...
            <div className="mb-500 flex flex-col gap-125">
              {plan.items.map((item) => (
                <div key={item.code} className="flex items-center gap-100">
                  <div className="flex h-250 w-250 shrink-0 items-center justify-center rounded-full bg-gray-200">
                    <Check className="h-150 w-150 text-gray-600" />
                  </div>
                  <p
                    className={cn(
                      item.valueAmount > 0
