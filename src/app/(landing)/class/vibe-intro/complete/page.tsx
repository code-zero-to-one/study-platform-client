      ...
      <div className="mx-auto flex max-w-page flex-col items-center px-600 py-800">
        ...
        <div className="mt-500 flex gap-200">
          {[
            ...
            <div
              key={s.label}
              className="flex h-[100px] w-[170px] flex-col items-center justify-center gap-25 rounded-200 border border-rose-300 bg-rose-50"
            >
        ...
        <div className="mt-500 flex gap-200">
          <button
            ...
            className="flex h-[50px] w-[310px] items-center justify-center gap-50 rounded-100 bg-background-brand-default font-designer-18b text-text-inverse"
          >
          ...
          <button
            type="button"
            className="flex h-[50px] w-[310px] items-center justify-center gap-50 rounded-100 border border-border-brand bg-background-default font-designer-18b text-text-brand"
          >
            <Image
        ...
        {/* Message card */}
        <div className="mt-500 w-[663px] rounded-br-[60px] rounded-tl-[60px] rounded-tr-[60px] border border-rose-300 p-400 text-center shadow-1">
          <p className="font-designer-16b text-text-brand">
            {recap?.studyDays ?? 5}
          </p>
        ...
        <textarea
          ...
          className={cn(
            'mt-300 h-[130px] w-[856px] resize-none rounded-200 border border-border-default p-300 font-designer-16m text-gray-800 outline-none placeholder:text-gray-400',
        ...
        <div className="mt-400 flex gap-200">
          <Link
            ...
            className="flex h-[60px] w-[310px] items-center justify-center rounded-100 bg-background-brand-default font-designer-18b text-text-inverse"
          >
            빌더들의 바이브 보기
          </Link>
          <Link
            ...
            className="flex h-[60px] w-[310px] items-center justify-center rounded-100 border border-border-brand bg-background-default font-designer-18b text-text-brand"
          >
            내 빌더 필드 모아보기
          </Link>
        </div>
