    ...
    <div className="mt-500 flex items-center justify-center gap-50">
      {pages.map((p) => (
        <button
          ...
          className={cn(
            'flex size-500 items-center justify-center rounded-100 font-designer-16r',
            p === currentPage
      ...
      {windowEnd < totalPages && (
        <button
          ...
          className="flex size-500 items-center justify-center rounded-100 font-designer-16r text-gray-700 hover:bg-gray-100"
        >
          LAST
        </button>
      )}
