...
import { AdminLessonReflectionsPageClient } from '@/components/admin/courses/admin-lesson-operations-page-client';
...
export default async function AdminLessonReflectionsPage({
  params,
  searchParams,
}: {
  ...
  return (
    <AdminLessonReflectionsPageClient
