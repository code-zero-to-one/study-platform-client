...
} from '@/hooks/queries/admin/admin-course-payment-api';
  ...
  return (
    <>
      <tr className="border-b-border-default border-b">
        ...
        <td className="py-200 pl-125">
          <span className="font-designer-14r text-text-default">
            {payment.amount.toLocaleString()}원({payment.paymentMethod || '-'})
          </span>
        </td>
        <td className="py-200 pl-125">
          <Badge color={statusConfig.color} shape="rectangle">
...
function PaymentDetailField({
  ...
  return (
    <div className="border-border-default rounded-100 flex flex-col gap-050 border p-150">
