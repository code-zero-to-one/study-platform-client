...
> **이 저장소(study-platform-client)는 `.husky/prepare-commit-msg`가 이미 포함되어 있습니다.**
> 별도 설치 없이 `git pull` 이후 자동 적용됩니다.

아래는 **다른 프로젝트**에 적용할 때의 설치 방법입니다.
